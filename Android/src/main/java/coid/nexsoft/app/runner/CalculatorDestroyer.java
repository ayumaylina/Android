...
public class CalculatorDestroyer {
	...
	public Object[][] dataDrivenPost()
	{
		...
		while(rX.hasNext())
		{
			...
			for(int j=0;j<intColumnNums;j++)
			{
				...
				//System.out.println("intNumX adalah "+intNumX);
				//System.out.println("intOperator adalah "+intOperator);
			}
			a++;
			//System.out.println("intOperator adalah "+intOperator);
		}
	...
	{		
		...
		System.out.println("Angka pertama--> "+intNumX);
		for(int i=0;i<intLoopCalc;i++)
		{
			...
			System.out.println("Note : Operator 0 --> pengurangan ");
			System.out.println("       Operator 1 --> perkalian ");
			System.out.println("       Operator 2 --> pembagian ");
			System.out.println("       Operator 3 --> penjumlahan ");
			System.out.println("       Operator 4 --> pengurangan ");
//			public double getResult(double result,int number, int operator)
			...
			if(i==0)
			{
				...
				System.out.println("Hasil perhitungan "+doubResultExpected);
			}
			else
			{
		...
		//System.out.println("Hasil Calculator destroyer"+calcDestroyer); //calc destroyer
